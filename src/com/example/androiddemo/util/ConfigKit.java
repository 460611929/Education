...
import com.example.androiddemo.AppApplication;
...
{
	private static SharedPreferences sp = AppApplication.getContext().getSharedPreferences("config", Context.MODE_PRIVATE);
	...
	public static SharedPreferences getShadredPreferences(String name)
	{
		if (sp == null)
		{
			sp = AppApplication.getContext().getSharedPreferences(name, Context.MODE_PRIVATE);
		}
		return sp;
	}
